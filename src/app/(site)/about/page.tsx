            ...
            <div className="lg:col-span-6">
              ...
              <Reveal delay={0.1} className="prose-body mt-9 text-lg text-ink-2">
                <p>
                  ...
                  we rebuilt after a refusal told their office. Six years on,
                  the majority of the people who walk into our Kurla office
                  were sent by someone we have already travelled.
                </p>
                <p>
